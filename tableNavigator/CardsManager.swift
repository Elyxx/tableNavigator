...
class CardsManager{
    ...
    func addNewCard(name: String? = nil, descrip: String? = nil, filter: Int32? = nil, previewIMG: String? = nil, frontIMG: String? = nil, backIMG: String? = nil, barcodeIMG: String? = nil){
        ...
        newCard.previewImageOfCard = previewIMG
    ...
    func editExisting(card: DiscountCard, name: String? = nil, descrip: String? = nil, filter: Int32? = nil, previewIMG: String? = nil, frontIMG: String? = nil, backIMG: String? = nil, barcodeIMG: String? = nil){
        if name != nil { card.nameOfCard = name }
        if descrip != nil { card.descriptionOfCard = descrip }
        if filter != nil { card.filterByColor = filter! }
        if previewIMG != nil {card.previewImageOfCard = previewIMG }
    ...
    func getFilteredCards(filter: Int32? = nil)->[DiscountCard]?{
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "DiscountCard")
        if filter != nil {
            fetchRequest.predicate = NSPredicate(format: "filterByColor == %d", filter!)
        }
        //var error: NSError?
